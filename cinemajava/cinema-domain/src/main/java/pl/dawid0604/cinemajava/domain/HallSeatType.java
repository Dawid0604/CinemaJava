...
public final class HallSeatType {
    private final Long id;
    private final String name;

    public static Result<HallSeatType> create(final Long id, final String name) {
        if (id != null && id < 0) {
        ...
        return new Result.Success<>(new HallSeatType(id, name));
    }

    private static Result<HallSeatType> createFailure(final String message) {
